...
export default defineConfig({
  entry: {
    ...
    'hooks/hook-record-claim': 'src/hooks/hook-record-claim.ts',
    'hooks/hook-warn-contradicting-claim': 'src/hooks/hook-warn-contradicting-claim.ts',
    'hooks/hook-record-source-query': 'src/hooks/hook-record-source-query.ts',
    'hooks/hook-verify-before-assert': 'src/hooks/hook-verify-before-assert.ts',
  },
  format: ['cjs'],
  target: 'node20',
  clean: true,
