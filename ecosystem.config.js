  ...
  apps: [
    {
      ...
      script: "/Users/chrisjackson/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/chrisjackson/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/chrisjackson/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/chrisjackson/cortextos",
        CTX_PROJECT_ROOT: "/Users/chrisjackson/cortextos",
        CTX_ORG: process.env.CTX_ORG || "main",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: 'npm',
      args: 'run dev',
      cwd: "/Users/chrisjackson/cortextos/dashboard",
      env: {
